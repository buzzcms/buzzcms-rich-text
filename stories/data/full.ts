...
export const full = [
  ...
  },
  {
    type: 'paragraph',
    children: [
      { text: 'That’s why we man need a separate place - ' },
      { text: 'a beer fridge', bold: true },
      { text: ' - to store our favorite suds.' },
    ],
  },
  {
    type: 'paragraph',
  ...
  },
  {
    ...
    children: [
      {
        text:
          'This review will guide you to find the best beer fridge that suits your need, whether it’s hosting parties or dealing with the end of your day at your leisure. Rather than the fancy options, we chose to focus on the models that are popular, affordable, user-friendly to help you find the most practical options.We also took time to read hundreds of reviews from previous buyers to see if the fridges live up to their claims. Finally, we came up with five beverage centers we think are worth for money.',
      },
    ],
  },
  {
  ...
  { type: 'heading-two', children: [{ text: 'Table of Contents' }] },
  {
    type: 'heading-two',
    children: [
      {
  ...
  },
  {
    ...
    children: [
      {
        text: 'Some even state that beer fridge is a must to completing your ',
      },
      {
        type: 'link',
        url: 'http://en.wikipedia.org/wiki/Man_cave%20%22man%20cave%E2%80%9D',
        children: [{ text: 'man cave' }],
      },
      {
        text:
          ', your dorm room, to safely and securely storing your beverage of choice.',
      },
    ],
  },
  {
  ...
  {
    type: 'heading-three',
    children: [{ text: '1. Size, Storage Space/Capacity.' }],
  },
  {
    type: 'paragraph',
    children: [
  ...
  {
    type: 'heading-three',
    children: [{ text: '2. Cooling system: Compressor or thermoelectric?' }],
  },
  {
    type: 'paragraph',
    children: [
      {
        text:
          'Most of the high-quality beer fridge manufacturers make their products with ',
      },
      {
        type: 'link',
        url: 'https://en.wikipedia.org/wiki/Refrigerator',
        children: [{ text: 'compressors' }],
      },
      {
        text:
          ' just like the full-size models. But some smaller, and cheaper models utilize the ',
      },
      {
        type: 'link',
        url: 'https://en.wikipedia.org/wiki/Thermoelectric_generator',
        children: [{ text: 'thermoelectric' }],
      },
      { text: ' cooling system to chill the beverage.' },
    ],
  },
  {
    type: 'paragraph',
  ...
  },
  {
    type: 'list-item',
    children: [
      { text: 'Very cold (0-4C/32-39F):', bold: true },
      {
        text:
  ...
  },
  {
    type: 'list-item',
    children: [
      { text: 'Cold (4-7C/39-45F):', bold: true },
      {
        text:
  ...
  },
  {
    type: 'list-item',
    children: [
      { text: 'Cool (8-12C/45-54F):', bold: true },
      {
        text:
  ...
  },
  {
    type: 'list-item',
    children: [
      { text: 'Cellar (12-14C/54-57F):', bold: true },
      {
        text:
  ...
  },
  {
    type: 'list-item',
    children: [
      { text: 'Warm (14-16C/57-61F): ', bold: true },
      {
        text:
  ...
  { type: 'heading-three', children: [{ text: '4. Adjustable shelves' }] },
  {
    type: 'paragraph',
    children: [
      {
  ...
  { type: 'heading-three', children: [{ text: '5. Appearance' }] },
  {
    type: 'paragraph',
    children: [
      {
  ...
  { type: 'heading-three', children: [{ text: '6. Mobility' }] },
  {
    type: 'paragraph',
    children: [
      {
  ...
  { type: 'heading-three', children: [{ text: '7. Ventilation' }] },
  {
    type: 'paragraph',
    children: [
      {
  ...
  { type: 'heading-three', children: [{ text: '8. Price, of course' }] },
  {
    type: 'paragraph',
    children: [
      {
  ...
  {
    type: 'heading-two',
    children: [{ text: 'Top 5 Beer Refrigerators to Buy in 2017' }],
  },
  {
    type: 'paragraph',
    children: [
  ...
  },
  {
    type: 'heading-three',
    children: [
      { text: '1. The Garage Ready: The Igloo FR329 Fridge Tool Box' },
    ],
  },
  {
    type: 'paragraph',
  ...
  { type: 'paragraph', children: [{ text: '[[shortcode here]]' }] },
  {
    type: 'paragraph',
    children: [
      {
